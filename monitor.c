...
struct option main_options[] = {
    ...
    OPT_BOOL_NONEG  ( 0 ,   "aux", &env.aux,                          "print ps aux info"),
     ...
     OPT_BOOL_NONEG  ( 0 ,   "unix_file", &env.unix_file,                          "print unix_file type"),
      OPT_BOOL_NONEG  ( 0 ,   "details", &env.details,                          "print task details"),
    ...
    OPT_STRDUP_NONEG( 0 ,    "grep", &env.grep,    "grep",         "pgrep and pidof"),
    OPT_STRDUP_NONEG( 0 ,    "allocs", &env.allocs,    "allocs",         "alloc str"),
    OPT_STRDUP_NONEG( 0 ,    "flamegraph", &env.flamegraph,    "flamegraph",         "flame graph "),
    OPT_STRDUP_NONEG( 0 ,    "frees", &env.frees,    "frees",         "free str"),
     OPT_INT_NONEG   (0,    "pidof", &env.pidof,   "pidof",            "pgrep pid"),
     OPT_INT_NONEG   (0,    "ppid", &env.ppid,   "ppid",            "kill ppid"),
     OPT_INT_NONEG   (0,    "port", &env.port,   "port",            "grep port"),
